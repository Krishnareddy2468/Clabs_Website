...
DROP POLICY IF EXISTS "Anyone can read contacts" ON contact_responses;
DROP POLICY IF EXISTS "Anyone can insert contacts" ON contact_responses;
DROP POLICY IF EXISTS "Anyone can update contacts" ON contact_responses;
DROP POLICY IF EXISTS "Anyone can delete contacts" ON contact_responses;
...
-- CONTACT_RESPONSES: Public read and insert
...
WHERE schemaname = 'public'
  AND tablename IN ('schools', 'events', 'gallery', 'contact_responses', 'event_registrations')
ORDER BY tablename;
