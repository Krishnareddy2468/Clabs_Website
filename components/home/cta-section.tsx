  ...
  return (
    <section className="relative py-16 sm:py-24 md:py-28 lg:py-36">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-r from-indigo-700 via-indigo-600 to-indigo-500 p-6 sm:p-10 md:p-12 lg:p-20 text-center shadow-2xl shadow-indigo-500/20">
          ...
          <div className="relative">
            ...
            <div className="flex flex-col items-center justify-center gap-3 sm:gap-4 sm:flex-row">
              <Button
                size="lg"
                className="w-full sm:w-auto rounded-full bg-white px-6 sm:px-8 py-5 sm:py-6 text-sm sm:text-base font-bold text-indigo-600 shadow-lg hover:bg-indigo-50 hover:scale-105 transition-all"
                asChild
              >
                <Link href="/contact">
                  ⭐ Enroll Now
