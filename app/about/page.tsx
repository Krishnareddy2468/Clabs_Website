	...
	return (
		<div className="flex min-h-screen flex-col">
			...
			<main className="flex-1">
									...
									>
										<div className={`flex-1 ${index % 2 === 0 ? "md:text-right" : "md:text-left"}`}>
											...
											>
												...
												<h3 className="mb-2 text-base sm:text-lg font-semibold text-[#0A1B2A]">
													{item.title}
												</h3>
						...
						<div className="grid gap-6 sm:gap-8 md:gap-10 grid-cols-1 md:grid-cols-3">
							{approaches.map((approach, index) => (
								<div key={index} className="text-center">
									...
									<h3 className="mb-2 sm:mb-3 text-lg sm:text-xl font-semibold text-[#0A1B2A]">
										{approach.title}
									</h3>
									<p className="text-sm sm:text-base text-[#4A6382] leading-relaxed">
				...
				<section
					id="team"
					className="bg-gradient-to-b from-[#f0f7ff] to-[#e8f4ff] py-16 sm:py-20 md:py-24 lg:py-32"
				>
					<div className="container mx-auto px-4 sm:px-6 lg:px-8">
						<h2 className="mb-10 sm:mb-12 md:mb-16 text-center text-2xl sm:text-[2rem] md:text-[2.5rem] font-semibold text-[#0A1B2A]">
							Meet Our Team
								...
								<div key={index} className="premium-card group text-center">
									<div className="mb-3 sm:mb-5 overflow-hidden rounded-xl sm:rounded-2xl border border-border/50 bg-white">
										<img
											src={
												member.image ||
												"/placeholder.svg?height=300&width=300&query=professional portrait"
											}
											alt={member.name}
											className="h-48 sm:h-56 md:h-64 lg:h-72 w-full object-cover transition-transform duration-500 group-hover:scale-105"
										/>
									</div>
									<h3 className="text-sm sm:text-base md:text-lg font-semibold text-[#0A1B2A]">
										{member.name}
									</h3>
